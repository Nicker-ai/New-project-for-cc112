...
menu:
	...
	errorchecking:
		...
		printf("\t\t\t|=||==||==||    PRESS (Y) KEY TO RETURN TO MENU   ||==||==||=|\n");
		printf("\t\t\t|=||==||==||        PRESS (X) KEY TO LOG OUT      ||==||==||=|\n");
		printf("\t\t\t|=||==||==||                                      ||==||==||=|\n");
		printf("\t\t\t[][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][]\n");
		printf("\n");
		printf("\t\t\t==============================================================\n");
		printf("\t\t\t[][][] PRESSING OTHER KEY WILL TERMINATES THE PROGRAM [][][][]\n");
		printf("\t\t\t==============================================================\n");
		printf("\t\t\t[][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][]\n");
        ...
        switch (choice) {
            ...
            default:
                ...
                char decision;
					...
					printf("\t\t\t|=||==||==||    INPUT CHOICE IS NOT ON THE LIST   ||==||==||=|\n");
					printf("\t\t\t|=||==||==||    PRESS (Y) KEY TO RETURN TO MENU   ||==||==||=|\n");
					printf("\t\t\t|=||==||==||     PRESS (X) KEY TO END PROGRAM     ||==||==||=|\n");
					printf("\t\t\t|=||==||==||                                      ||==||==||=|\n");
					printf("\t\t\t[][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][]\n");
					printf("\n");
					printf("\t\t\t==============================================================\n");
